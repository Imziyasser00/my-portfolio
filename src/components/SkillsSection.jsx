...
const SkillsSection = () => {
  const text =
    "Hello! I'm a web developer with expertise in ReactJs, UI Design, Java, PHP, and C/C++. Specializing in the MERN stack, I deliver seamless, responsive web applications with a focus on clean and efficient code.".split(
      " "
    );
  return (
